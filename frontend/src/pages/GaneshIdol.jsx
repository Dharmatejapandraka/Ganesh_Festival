...
function GaneshIdol() {
  ...
  const fetchIdols = async () => {
    ...
    try {
      ...
      const data =
        await apiFetch(
          `/ganesh-idols?year=${currentYear}`
        );


      console.log(
        "GANESH IDOLS RESPONSE:",
        data
      );
    ...
    <div className="idol-page">
      ...
      {!canEdit && (
        ...
        >
          ...
          . You can view Ganesh idols
          but cannot add or delete them.
